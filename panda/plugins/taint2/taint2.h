...
PPP_CB_TYPEDEF(void, on_branch2, Addr, uint64_t, bool, bool*);
PPP_CB_TYPEDEF(void, on_indirect_jump, Addr, uint64_t, bool, bool*);
PPP_CB_TYPEDEF(void, on_taint_change, Addr, uint64_t);
PPP_CB_TYPEDEF(void, on_taint_prop, Addr, Addr, uint64_t);
PPP_CB_TYPEDEF(void, on_ptr_load, Addr, uint64_t, uint64_t);
PPP_CB_TYPEDEF(void, on_ptr_store, Addr, uint64_t, uint64_t);
PPP_CB_TYPEDEF(void, on_after_load, Addr, uint64_t, uint64_t);
PPP_CB_TYPEDEF(void, on_after_store, Addr, uint64_t, uint64_t);
