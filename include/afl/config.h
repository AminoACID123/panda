...
#define MESSAGE_LIST_SCRATCH_LEN 10
#define TESTCASE_MAX_CACHE_SIZE 8
#define TESTCASE_MAX_CACHE_ENTRIES 50
...
#define TMOUT_LIMIT 5U

#define IUT_INIT_TRY_MAX   3
